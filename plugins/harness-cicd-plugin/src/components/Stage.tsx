...
const Stage: React.FC = () => {
  ...
  React.useEffect(() => {
      ...
      // const context = usePluginContext();
      // const secret = context.user!.secrets.harness-account-identifier;
          ...
          for (a in pipelineResult) {
            ...
            if (accountIDAvailable) {
              ...
              for(c in pipelineInputSetResult.data.content){
                console.log('>>>>>>>>>  >>>>> >> pipelineInputSetResult is ' + JSON.stringify(pipelineInputSetResult.data.content[c].name));
